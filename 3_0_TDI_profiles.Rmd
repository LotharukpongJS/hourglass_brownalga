...
Ec_DES_25f_tS.rlog_processed <-
  tibble::as_tibble(Ec_DES_25f_tS.rlog, rownames = "transformation") %>%
  dplyr::mutate(transformation = "rlog")

Ec_DES_25f_tS_res <- 
  dplyr::bind_rows(Ec_DES_25f_tS_processed, Ec_DES_25f_tS.rlog_processed) %>%
  dplyr::rename("pval" = value) %>%
  dplyr::mutate(test = "FlatLineTest")
...
Ec_DES_32m_tS.rlog_processed <-
  tibble::as_tibble(Ec_DES_32m_tS.rlog, rownames = "transformation") %>%
  dplyr::mutate(transformation = "rlog")

Ec_DES_32m_tS_res <- 
  dplyr::bind_rows(Ec_DES_32m_tS_processed, Ec_DES_32m_tS.rlog_processed) %>%
  dplyr::rename("pval" = value) %>%
  dplyr::mutate(test = "FlatLineTest")
```
