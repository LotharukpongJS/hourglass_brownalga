...
resnonDEG_24H48H <- read_csv("GO_input/resnonDEG_24H48H_Fs.csv", show_col_types = FALSE) %>% 
  mutate(stage = "24H_to_48H") %>% 
  mutate(test = "nonDEG") %>%
  mutate(species = "Fs")
resnonDEG_48H1w <- read_csv("GO_input/resnonDEG_48H1w_Fs.csv", show_col_types = FALSE) %>% 
  mutate(stage = "48H_to_1w") %>% 
  mutate(test = "nonDEG") %>%
  mutate(species = "Fs")
resnonDEG_1w3w <- read_csv("GO_input/resnonDEG_1w3w_Fs.csv", show_col_types = FALSE) %>% 
  mutate(stage = "1w_to_3w") %>% 
  mutate(test = "nonDEG") %>%
  mutate(species = "Fs")
resnonDEG_3w4w <- read_csv("GO_input/resnonDEG_3w4w_Fs.csv", show_col_types = FALSE) %>% 
...
resnonDEG_24H48H_Fd <- read_csv("GO_input/resnonDEG_24H48H_Fd.csv", show_col_types = FALSE) %>%
  mutate(stage = "1E_to_2E") %>% 
  mutate(test = "nonDEG") %>%
  mutate(species = "Fd")
resnonDEG_48H1w_Fd <- read_csv("GO_input/resnonDEG_48H1w_Fd.csv", show_col_types = FALSE) %>%
  mutate(stage = "2E_to_3E") %>% 
  mutate(test = "nonDEG") %>%
  mutate(species = "Fd")
resnonDEG_1w3w_Fd <- read_csv("GO_input/resnonDEG_1w3w_Fd.csv", show_col_types = FALSE) %>% 
  mutate(stage = "3E_to_4E") %>% 
  mutate(test = "nonDEG") %>%
  mutate(species = "Fd")
resnonDEG_3w4w_Fd <- read_csv("GO_input/resnonDEG_3w4w_Fd.csv", show_col_types = FALSE) %>% 
