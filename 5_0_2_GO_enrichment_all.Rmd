...
resnonDEG_E1E2_Fd <- Fd_ddsObj.wald_nonDEGlist[[1]] %>% 
        tibble::as_tibble(rownames = "GeneID") %>% 
        dplyr::mutate(stage = "1E_to_2E") %>% 
        dplyr::mutate(test = "nonDEG") %>%
        dplyr::mutate(species = "Fd")
resnonDEG_E2E3_Fd <- Fd_ddsObj.wald_nonDEGlist[[2]] %>% 
        tibble::as_tibble(rownames = "GeneID") %>% 
        dplyr::mutate(stage = "2E_to_3E") %>% 
        dplyr::mutate(test = "nonDEG") %>%
        dplyr::mutate(species = "Fd")
resnonDEG_E3E4_Fd <- Fd_ddsObj.wald_nonDEGlist[[3]] %>% 
        tibble::as_tibble(rownames = "GeneID") %>% 
        dplyr::mutate(stage = "3E_to_4E") %>% 
        dplyr::mutate(test = "nonDEG") %>%
        dplyr::mutate(species = "Fd")
resnonDEG_E4E5_Fd <- Fd_ddsObj.wald_nonDEGlist[[4]] %>% 
        tibble::as_tibble(rownames = "GeneID") %>% 
        dplyr::mutate(stage = "4E_to_5E") %>% 
        dplyr::mutate(test = "nonDEG") %>%
        dplyr::mutate(species = "Fd")
resnonDEG_E5E6_Fd <- Fd_ddsObj.wald_nonDEGlist[[5]] %>% 
        tibble::as_tibble(rownames = "GeneID") %>% 
        dplyr::mutate(stage = "5E_to_6E") %>% 
        dplyr::mutate(test = "nonDEG") %>%
        dplyr::mutate(species = "Fd")

combined_table <- rbind(resnonDEG_24H48H, resnonDEG_48H1w, resnonDEG_1w3w, resnonDEG_3w4w,
                        resnonDEG_E1E2_Fd, resnonDEG_E2E3_Fd, resnonDEG_E3E4_Fd, resnonDEG_E4E5_Fd, resnonDEG_E5E6_Fd)
```
