...
# Fucus distichus
contrast_list <- 
  c("E2 vs E1", "E3 vs E2", "E4 vs E3", "E5 vs E4", "E6 vs E5")
Fd_DEG_contrasts <-
...
This was added because of the high number of DEGs found between the last stages.

#### E6 vs E5

```{r}
contrast = "E6 vs E5"
genes_for_analysis = dplyr::filter(Fd_DEG_contrasts, contrast == contrast)
