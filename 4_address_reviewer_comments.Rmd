...
# ggplot2::ggsave(filename = "Fs_Ec_pearson.pdf", device = "pdf", width = 4.5, height = 3.5)
```
...
M_melt.prep |>
        ...
        ggplot2::labs(x = "Fucus distichus stages",
                      ...
                      colour = "Ectocarpus stages") +
        ggplot2::theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))
# ggplot2::ggsave(filename = "Fd_Ec_pearson.pdf", device = "pdf", width = 4.5, height = 3.5)
```
...
M_melt.prep |>
        ...
        ggplot2::labs(x = "Fucus serratus stages",
                      ...
                      colour = "Ectocarpus stages") +
        ggplot2::theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))
# ggplot2::ggsave(filename = "Fs_Ec_spearman.pdf", device = "pdf", width = 4.5, height = 3.5)
```
...
M_melt.prep |>
        ...
        ggplot2::labs(x = "Fucus distichus stages",
                      ...
                      colour = "Ectocarpus stages") +
        ggplot2::theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))
# ggplot2::ggsave(filename = "Fd_Ec_spearman.pdf", device = "pdf", width = 4.5, height = 3.5)
```
...
M_melt.prep |>
        ...
        ggplot2::labs(x = "Fucus serratus stages",
                      ...
                      colour = "Ectocarpus stages") +
        ggplot2::theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))
# ggplot2::ggsave(filename = "Fs_Ec_Manhattan.pdf", device = "pdf", width = 4.5, height = 3.5)
```
...
M_melt.prep |>
        ...
        ggplot2::labs(x = "Fucus distichus stages",
                      ...
                      colour = "Ectocarpus stages") +
        ggplot2::theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))
# ggplot2::ggsave(filename = "Fd_Ec_Manhattan.pdf", device = "pdf", width = 4.5, height = 3.5)
```
...
M_melt.prep |>
        ...
        ggplot2::labs(x = "Fucus serratus stages",
                      ...
                      colour = "Ectocarpus stages") +
        ggplot2::theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))
# ggplot2::ggsave(filename = "Fs_Ec_JSD.pdf", device = "pdf", width = 4.5, height = 3.5)
```
...
M_melt.prep |>
        ...
        ggplot2::labs(x = "Fucus distichus stages",
                      ...
                      colour = "Ectocarpus stages") +
        ggplot2::theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))
# ggplot2::ggsave(filename = "Fd_Ec_JSD.pdf", device = "pdf", width = 4.5, height = 3.5)
```
